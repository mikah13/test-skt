...
class Add extends React.Component {
  ...
  generateTextField = (a, idx, s, parents) => {
    ...
    return <div style={{
      ...
      <TextField placeholder={desc} error {helperText.trim() === ""?false:true} key={`tf-${idx}`} id={prop} required={this.props.schema.required.indexOf(prop) !== -1
          ? true
